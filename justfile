...
audit:
    cd apps/api; uv run python scripts/run_workspace_audit.py all
...
api-audit:
    cd apps/api; uv run python scripts/run_workspace_audit.py api
...
web-audit:
    cd apps/api; uv run python scripts/run_workspace_audit.py web
...
desktop-audit:
    cd apps/api; uv run python scripts/run_workspace_audit.py desktop
