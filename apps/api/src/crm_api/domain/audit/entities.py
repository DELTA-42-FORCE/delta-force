...
class AuditAction(StrEnum):
    ...
    CLIENT_FOLDER_PROFILE_EXPORTED = "client_folder.profile_exported"
    ...
    EMAIL_SENDER_SETTINGS_UPDATED = "email_sender_settings.updated"
    EMAIL_SENDER_SETTINGS_VIEWED = "email_sender_settings.viewed"
    EMAIL_BATCH_SENT = "email_dispatch.batch_sent"
